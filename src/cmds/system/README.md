...
- `ctest_cmd.rs` compacts CTest green runs to summary + slowest tests and keeps failing-test output; explicit verbose/show-only/help/version flags bypass filtering.
